...
public interface JobApplicationsApi {
    ...
    @Operation(summary = "Modify Job Application", description = "", tags={ "Jobs" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<JobApplication> modifyJobApplicationWithId(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") Integer id
